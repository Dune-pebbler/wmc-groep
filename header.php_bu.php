...
<section class="uk-section c-top<?php echo $no_hero; echo (is_front_page()) ? ' c-top-home' : ''; ?>">	
    ...
    <div class="uk-container uk-container-large">
		<div uk-sticky>
			<a href="#" class="brand uk-visible@s uk-icon uk-totop" uk-totop uk-scroll><svg width="18" height="10" viewBox="0 0 18 10" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 9 9 1 17 9 "></polyline></svg></a>
